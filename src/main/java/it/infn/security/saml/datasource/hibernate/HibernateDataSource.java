...
public abstract class HibernateDataSource
    ...
    public UserResource updateUser(UserResource userRes, String[] versions)
        throws DataSourceException {
        ...
        try {
            ...
            if (!matchVersion(eUser.getVersion(), versions))
                throw new DataSourceException("Conflict on update", DataSourceException.CONFLICT);
    ...
    public UserResource createUser(UserResource userRes, boolean isBulkUserAdd)
        ...
        try {
            ...
            String newVer = HibernateUtils.generateNewVersion(null);
            eUser.setVersion(newVer);
            userRes.setResourceVersion(newVer);
    ...
    public GroupResource updateGroup(GroupResource groupRes, String[] versions)
        throws DataSourceException {
        Session session = sessionFactory.getCurrentSession();
        boolean nocommit = true;
        ...
        try {
            ...
            if (!matchVersion(eGroup.getVersion(), versions))
                throw new DataSourceException("Conflict on update", DataSourceException.CONFLICT);
